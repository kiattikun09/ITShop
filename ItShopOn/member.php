...
?>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="index.php">IT SHOP LOPBURI</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <?php
				if($cust_id != ""){ ?>
                <li class="nav-item">
              <a class="nav-link"href="member.php"><?php echo"สวัสดีคุณ:"." ".$firstname." ".$lastname; ?></a>
            </li>
                <li class="nav-item">
  ...
  <div class="col-sm-4">
    ...
    <?php while($tmp = mysqli_fetch_array($res)){ ?>
      <tr>
        ...
        <td><?=$tmp['email'];?></td>
        <td><?=$tmp['phone'];?></td>
        <td><div align="center"><a href="member-UP.php?cust_id=<?php echo $tmp['cust_id']; ?>">UP</a></div></td>
      </tr>
    </tbody>
  </table>
